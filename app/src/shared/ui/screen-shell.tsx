      ...
      <View className="flex-1 justify-center">
        ...
        >
          <View className="overflow-hidden rounded-[28px] border border-card-border bg-card px-6 py-7">
            <View className="absolute -inset-s-14 -top-14 h-40 w-40 rounded-full bg-brand-primary-soft opacity-60" />
            <View className="absolute -bottom-16 -inset-e-10 h-36 w-36 rounded-full bg-brand-primary-soft opacity-45" />
