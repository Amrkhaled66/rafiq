              ...
              <form onSubmit={(e) => {
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`h-14 w-full rounded-2xl border bg-[#fafafa] px-4 text-right text-base text-[#202020] outline-none transition placeholder:text-[#aaa] focus:bg-white focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/10 ${errors.name ? "border-brand-primary" : "border-[#e5e5e5]"
                      }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`h-14 w-full rounded-2xl border bg-[#fafafa] px-4 text-right text-base text-[#202020] outline-none transition placeholder:text-[#aaa] focus:bg-white focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/10 ${errors.phone ? "border-brand-primary" : "border-[#e5e5e5]"
                      }`}
                  />
